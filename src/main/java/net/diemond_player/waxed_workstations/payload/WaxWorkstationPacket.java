...
import net.diemond_player.waxed_workstations.WaxedWorkstations;
...
public record WaxWorkstationPacket(BlockPos pos) implements CustomPayload {
    public static final CustomPayload.Id<WaxWorkstationPacket> ID = new CustomPayload.Id<>(WaxedWorkstations.WAX_WORKSTATION_PACKET_ID);
